...
class Linkedin(object):
    ...
    def search_people(
        ...
        **kwargs,
        ...
        :start number of the first profile
        ...
        data = self.search(params, **kwargs, offset=start)
            ...
            results.append(
                {
                    ...
                    "Nome": item.get("publicIdentifier"),
                    "tracking_id": get_id_from_urn(item.get("trackingUrn")),
                    "Cargo":item["headline"]["text"],
                    "city":item["subline"]["text"],
                }
            )
